...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Describe in your own words what inject does.
      # I honestly still don't know... will need to google.
      # something similar to each? but with built in looping or something.
  end
  ...
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
    # because we don't need the file ever, just its contents, we don't need
    # to store it as such?
