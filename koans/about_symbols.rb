...
class AboutSymbols < Neo::Koan
  ...
  # against the string value rather than against symbols?
    # something to do with the object ids comparison? Idk...
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      assert_equal false, all_symbols_as_strings.include?("sound")
    end
  end
  ...
  # Why is it not a good idea to dynamically create a lot of symbols?
    # since they're effectively immutable you just have a bunch of intermediate data doing nothing
end
